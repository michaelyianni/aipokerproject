...
assert.strictEqual(activeTurnId === player2.id, true, "Active turn should be player 2");
...
let potAmount1 = gameEngine.tableStateRepository.pot.getTotal();
...
// Pot should reflect total bets
let potAmount2 = gameEngine.tableStateRepository.pot.getTotal();
...
let potFinalAmount = gameEngine.tableStateRepository.pot.getTotal();
...
assert.strictEqual(player1FinalChips, player1CurrentChips + potFinalAmount, "Player 1 should have won the pot");
assert.strictEqual(player3FinalChips, player3CurrentChips, "Player 3's chips should remain the same after losing the pot");
